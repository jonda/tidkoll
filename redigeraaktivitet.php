...
<a href="skrivinaktivitet.php"> Lägg till aktivitet </a> &nbsp; &nbsp;<a href="rapportsida.php"> Rapport </a>  <br>
</div>
<?php
require_once 'db.php';
...
// slut på del som visas om variabeln akt är satt
